...
public class ErpProductRespVO {
    ...
    @Schema(description = "变种skc列表", requiredMode = Schema.RequiredMode.REQUIRED)
    private List<Item> items;

    @Schema(description = "skc信息", requiredMode = Schema.RequiredMode.REQUIRED)
    @ExcelProperty("skc信息")
    ...
    public static class Item {
        ...
        @Schema(description = "产品变种编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "15672")
        private Long id;

        @Schema(description = "产品变种名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "李四")
        @ExcelProperty("产品变种名称")
        private String name;

        @Schema(description = "skc货号", requiredMode = Schema.RequiredMode.REQUIRED, example = "X110")
        private String barCode;

        @Schema(description = "父级产品id", requiredMode = Schema.RequiredMode.REQUIRED, example = "11161")
        private Long productId;
        @Schema(description = "产品变种分类", requiredMode = Schema.RequiredMode.REQUIRED, example = "水果")
        private String categoryName;
        ...
        @Schema(description = "产品变种状态", requiredMode = Schema.RequiredMode.REQUIRED, example = "2")
        @ExcelProperty("产品变种状态")
        private Integer status;

        @Schema(description = "产品变种规格", example = "红色")
        private String standard;

        @Schema(description = "产品变种备注", example = "你猜")
        @ExcelProperty("产品备注")
        private String remark;
